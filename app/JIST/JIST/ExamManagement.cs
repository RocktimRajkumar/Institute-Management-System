...
namespace JIST
{
    public partial class ExamManagement : Form
    {
        ...
        //Opening reports page when clicking reports button
        ...
        //Opening insertmarks page when clicking insertmarks button
        private void button2_Click(object sender, EventArgs e)
        {
            insertmarks mark = new insertmarks();
            this.Hide();
            mark.ShowDialog();
        }

        //Form closing
        private void ExamManagement_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
