...
namespace JIST
{
    public partial class StudentManagement : Form
    {
        ...
        //Opening update page when click update button
        ...
        //Form closing
        private void StudentManagement_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }

        //Opening delete page when click on delete button
