...
namespace JIST
{
    public partial class CollectiveInformation : Form
    {
        ...
        //Opening Studentdetails page when click on student detail button
        ...
        //Form closing
        private void CollectiveInformation_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        //Opening Staff detail page when click on staff detail button
        private void button2_Click(object sender, EventArgs e)
        {
            StaffDetail stafd = new StaffDetail();
            this.Hide();
            stafd.ShowDialog();
        }
    }
