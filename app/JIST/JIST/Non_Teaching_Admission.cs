...
namespace JIST
{
    public partial class Non_Teaching_Admission : Form
    {
        int i, nonteachcurvalue, percurvalue;
        int em, m, p;
        ...
        public Non_Teaching_Admission()
        {
            InitializeComponent();
            i = 0;
            nonteachcurvalue = percurvalue = 0;
        ...
        //Closing form
        private void Non_Teaching_Admission_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        //Generating Non-Teaching staff ID by click Generate button
        private void button3_Click(object sender, EventArgs e)
        {
            sequencecurval();
            textBox10.Text = "OS" + "/" + dateTimePicker2.Value.Date.ToString("yyyy") + "/" + nonteachcurvalue.ToString();
        }
        ...
        void sequencecurval()
        {
            ...
            string query = "select NONTEACHERSEQ.nextval from DUAL";
            string query1 = "drop sequence NONTEACHERSEQ";
            ...
            try
            {
                ...
                rdr2.Read();
                rdr3.Read();
                nonteachcurvalue = rdr.GetInt32(0);
        ...
        void sequencecreate()
        {
            ...
            string str = "DATA SOURCE=localhost:1521/xe; USER ID=IMS;password=enteryourchoice";
            OracleConnection con = new OracleConnection(str);
            string query = "create sequence NONTEACHERSEQ minvalue 1 maxvalue 999999 start with " + nonteachcurvalue + " increment by 1 nocycle order NOCACHE";
        ...
        void sequencenextval()
        {
            ...
            try
            {
                ...
                Non_Teaching_Admission tsa = new Non_Teaching_Admission();
                this.Hide();
                tsa.ShowDialog();
                con.Close();
            }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrWhiteSpace(textBox10.Text))
            {
                ...
                label64.Text = "Office Staff ID must be Generated";
                x = 1;
            }
            if (picpath == null)
            {
        ...
        void officestaffinsert()
        {
            //inserting into Office_Staff table
            string NonTeachid = "OS" + "/" + dateTimePicker2.Value.Date.ToString("yyyy") + "/";
            ...
            try
            {
                ...
                if (String.IsNullOrWhiteSpace(textBox23.Text))
                    query = "insert into OFFICE_STAFF values(concat('" + NonTeachid + "','" + nonteachcurvalue + "'),'" + percurvalue + "' ,'"+ comboBox2.Text + "','" + textBox25.Text + "','" + textBox2.Text + "',null)";
               else
                    query = "insert into OFFICE_STAFF values(concat('" + NonTeachid + "','" + nonteachcurvalue + "'),'" + percurvalue + "','" + comboBox2.Text + "','" + textBox25.Text + "','" + textBox2.Text + "','" + textBox23.Text + "')";
